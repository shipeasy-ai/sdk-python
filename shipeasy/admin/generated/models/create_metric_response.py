...
class CreateMetricResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned metric id.")
    name: StrictStr = Field(description="Metric name that was created.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateMetricResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateMetricResponse from a dict"""
        if obj is None:
            return None
