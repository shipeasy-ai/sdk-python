...
class UpsertI18nDraftKeyRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    key: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Dotted key path to stage, e.g. `home.cta`.")
    value: StrictStr = Field(description="Staged translated value for the key.")
    description: Optional[StrictStr] = Field(default=None, description="Optional human note stored with the staged key.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpsertI18nDraftKeyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpsertI18nDraftKeyRequest from a dict"""
        if obj is None:
            return None
