...
class CreateConfigResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned config id.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateConfigResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateConfigResponse from a dict"""
        if obj is None:
            return None
