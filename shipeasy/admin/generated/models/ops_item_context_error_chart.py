...
class OpsItemContextErrorChart(BaseModel):
    ...
    """ # noqa: E501
    series: List[OpsItemContextErrorChartSeriesInner] = Field(description="Occurrence buckets, oldest first. Buckets with no occurrences are omitted.")
    domain_from: Union[StrictFloat, StrictInt] = Field(description="Chart domain start — unix epoch milliseconds (the window's start).", alias="domainFrom")
