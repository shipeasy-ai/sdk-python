...
class UpdateAlertRuleResponse(BaseModel):
    """
    UpdateAlertRuleResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned alert-rule id.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateAlertRuleResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAlertRuleResponse from a dict"""
        if obj is None:
            return None
