...
class ListKeysResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[KeyRecord]
    next_cursor: Optional[StrictStr] = Field(description="Opaque cursor for the next page, or `null` on the last page. Pass it back as the `cursor` query parameter.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [KeyRecord.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
