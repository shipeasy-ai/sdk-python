...
class CreateMetricWithQueryIr(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "display_name", "folder", "event_name", "query_ir", "winsorize_pct", "default_min_effect_of_interest", "direction", "unit", "display"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateMetricWithQueryIr from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateMetricWithQueryIr from a dict"""
        if obj is None:
            return None
