...
class QueryIrGroupBy(BaseModel):
    """
    How the series is split. On the envelope rather than in `expr` because every leaf of one expression shares it.
    """ # noqa: E501
    op: StrictStr = Field(description="`by` names the output dimensions; `without` names the ones to drop.")
    labels: Annotated[List[Annotated[str, Field(strict=True)]], Field(max_length=8)] = Field(description="Labels the grouping names.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryIrGroupBy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryIrGroupBy from a dict"""
        if obj is None:
            return None
