...
class GateWhitelist(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Resolved gate id.")
    name: StrictStr = Field(description="The gate's stable `name`.")
    attr: GateWhitelistAttr
    entries: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="The whitelisted identities, in the order they are stored. Deduplicated case-sensitively; an empty array means the gate has no whitelist.")
    __properties: ClassVar[List[str]] = ["id", "name", "attr", "entries"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GateWhitelist from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GateWhitelist from a dict"""
        if obj is None:
            return None
