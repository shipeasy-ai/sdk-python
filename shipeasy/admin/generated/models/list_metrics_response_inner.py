...
class ListMetricsResponseInner(BaseModel):
    """
    A metric definition.
    """ # noqa: E501
    ...
    creator_email: Optional[StrictStr] = Field(default=None, description="Email of the user who created the metric, or `null` when unknown. List responses only.", alias="creatorEmail")
    updater_email: Optional[StrictStr] = Field(default=None, description="Email of the user who last edited the metric, or `null` when unknown. List responses only.", alias="updaterEmail")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "folder", "eventName", "query", "queryIr", "displayName", "presetId", "unit", "version", "deletedAt", "creatorEmail", "updaterEmail", "direction", "winsorizePct", "defaultMinEffectOfInterest", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListMetricsResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListMetricsResponseInner from a dict"""
        if obj is None:
            return None
