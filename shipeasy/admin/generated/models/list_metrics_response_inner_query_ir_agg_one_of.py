...
class ListMetricsResponseInnerQueryIrAggOneOf(BaseModel):
    """
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['count_users']):
            raise ValueError("must be one of enum values ('count_users')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListMetricsResponseInnerQueryIrAggOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListMetricsResponseInnerQueryIrAggOneOf from a dict"""
        if obj is None:
            return None
