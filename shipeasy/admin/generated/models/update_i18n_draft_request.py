...
class UpdateI18nDraftRequest(BaseModel):
    """
    Body for `PATCH /api/admin/i18n/drafts/{draftId}`. Transitions the draft's lifecycle state.
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="New lifecycle state for the draft.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateI18nDraftRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateI18nDraftRequest from a dict"""
        if obj is None:
            return None
