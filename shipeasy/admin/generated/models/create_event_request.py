...
class CreateEventRequest(BaseModel):
    ...
    properties: Optional[List[CreateEventRequestPropertiesInner]] = Field(default=None, description="Typed properties declared on the event. Defaults to an empty list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [CreateEventRequestPropertiesInner.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
