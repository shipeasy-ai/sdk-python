...
class CreateEventRequest(BaseModel):
    ...
    def name_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^[a-zA-Z0-9_][a-zA-Z0-9_\-.]{0,49}$", value):
            raise ValueError(r"must validate the regular expression /^[a-zA-Z0-9_][a-zA-Z0-9_\-.]{0,49}$/")
        return value
