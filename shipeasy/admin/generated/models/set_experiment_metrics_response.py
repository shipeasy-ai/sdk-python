...
class SetExperimentMetricsResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetExperimentMetricsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetExperimentMetricsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "metrics": [SetExperimentMetricsResponseMetricsInner.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None
        })
