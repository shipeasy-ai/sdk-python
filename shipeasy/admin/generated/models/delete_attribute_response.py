...
class DeleteAttributeResponse(BaseModel):
    ...
    """ # noqa: E501
    ok: StrictBool = Field(description="True when the attribute was archived.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteAttributeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteAttributeResponse from a dict"""
        if obj is None:
            return None
