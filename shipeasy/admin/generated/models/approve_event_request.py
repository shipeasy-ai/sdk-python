...
class ApproveEventRequest(BaseModel):
    ...
    properties: Optional[List[CreateEventRequestPropertiesInner]] = Field(default=None, description="Replaces the full property set (no merge). Omit to leave properties unchanged.")
