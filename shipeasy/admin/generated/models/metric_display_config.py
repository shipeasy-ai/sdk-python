...
class MetricDisplayConfig(BaseModel):
    ...
    """ # noqa: E501
    band: Optional[MetricDisplayConfigBand] = None
    forecast: Optional[MetricDisplayConfigForecast] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["band", "forecast"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetricDisplayConfig from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of band
        if self.band:
            _dict['band'] = self.band.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetricDisplayConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "band": MetricDisplayConfigBand.from_dict(obj["band"]) if obj.get("band") is not None else None,
            "forecast": MetricDisplayConfigForecast.from_dict(obj["forecast"]) if obj.get("forecast") is not None else None
        })
