...
class UpdateI18nKeyResponse(BaseModel):
    """
    Updated key id.
    """ # noqa: E501
    id: StrictStr = Field(description="Id of the key that was updated.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateI18nKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateI18nKeyResponse from a dict"""
        if obj is None:
            return None
