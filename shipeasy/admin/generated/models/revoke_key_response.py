...
class RevokeKeyResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Id of the key that was revoked.")
    revoked: StrictBool
    __properties: ClassVar[List[str]] = ["id", "revoked"]

    @field_validator('revoked')
    def revoked_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RevokeKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RevokeKeyResponse from a dict"""
        if obj is None:
            return None
