...
class CreateExperimentReadoutResponse(BaseModel):
    """
    CreateExperimentReadoutResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Id of the newly minted readout snapshot.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateExperimentReadoutResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateExperimentReadoutResponse from a dict"""
        if obj is None:
            return None
