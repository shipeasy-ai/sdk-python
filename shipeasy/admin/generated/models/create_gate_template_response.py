...
class CreateGateTemplateResponse(BaseModel):
    """
    CreateGateTemplateResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned template id (`gtpl_…`).")
    name: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateGateTemplateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateGateTemplateResponse from a dict"""
        if obj is None:
            return None
