...
class CreateGateResponse(BaseModel):
    ...
    CreateGateResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned gate id (`gat_…`).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateGateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateGateResponse from a dict"""
        if obj is None:
            return None
