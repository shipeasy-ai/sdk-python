...
class CreateI18nProfileResponse(BaseModel):
    """
    Created profile id + name.
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned profile id.")
    name: StrictStr = Field(description="Profile handle that was created.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateI18nProfileResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateI18nProfileResponse from a dict"""
        if obj is None:
            return None
