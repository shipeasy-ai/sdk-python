...
class UpdateConfigSchemaResponse(BaseModel):
    """
    UpdateConfigSchemaResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Config id whose schema was updated.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateConfigSchemaResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateConfigSchemaResponse from a dict"""
        if obj is None:
            return None
