...
class CreateExperimentResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned experiment id.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateExperimentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateExperimentResponse from a dict"""
        if obj is None:
            return None
