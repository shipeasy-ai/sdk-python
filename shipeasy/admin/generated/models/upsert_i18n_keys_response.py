...
class UpsertI18nKeysResponse(BaseModel):
    """
    Result of a bulk key upsert. The affected profile's KV snapshot is rebuilt (and the CDN purged) before this returns.
    """ # noqa: E501
    upserted: Union[StrictFloat, StrictInt] = Field(description="Number of keys written (inserted or overwritten).")
    chunk: StrictStr = Field(description="The chunk the keys were filed under.")
    __properties: ClassVar[List[str]] = ["upserted", "chunk"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpsertI18nKeysResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpsertI18nKeysResponse from a dict"""
        if obj is None:
            return None
