...
class ListAlertRulesResponseInnerNotify(BaseModel):
    """
    Delivery target for this rule's alert; `null` = use the project default.
    """ # noqa: E501
    slack_channel: Optional[ListAlertRulesResponseInnerNotifySlackChannel] = Field(default=None, alias="slackChannel")
    email: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Email address to notify for this rule (overrides the default recipient).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAlertRulesResponseInnerNotify from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAlertRulesResponseInnerNotify from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "slackChannel": ListAlertRulesResponseInnerNotifySlackChannel.from_dict(obj["slackChannel"]) if obj.get("slackChannel") is not None else None,
            "email": obj.get("email")
        })
        return _obj
