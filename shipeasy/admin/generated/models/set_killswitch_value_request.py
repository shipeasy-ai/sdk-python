...
class SetKillswitchValueRequest(BaseModel):
    """
    Body for `PUT /api/admin/killswitches/{id}/value`. Sets the flat `value` on one env without touching `switches` or other envs.
    """ # noqa: E501
    env: Env
    value: StrictBool = Field(description="Flat boolean to publish on `env`. Publishes a new version on that env only.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetKillswitchValueRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetKillswitchValueRequest from a dict"""
        if obj is None:
            return None
