...
class DeleteOpsItemResponse(BaseModel):
    """
    Response for `DELETE /api/admin/ops/{handle}`.
    """ # noqa: E501
    ok: StrictBool = Field(description="Always `true` — the item (and its comments, attachments, tags, and investigation records) was deleted.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteOpsItemResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteOpsItemResponse from a dict"""
        if obj is None:
            return None
