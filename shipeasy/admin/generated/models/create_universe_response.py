...
class CreateUniverseResponse(BaseModel):
    """
    CreateUniverseResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned universe id.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateUniverseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateUniverseResponse from a dict"""
        if obj is None:
            return None
