...
class CreateMetricRequest(BaseModel):
    ...
    winsorize_pct: Annotated[int, Field(le=99, strict=True, ge=1)] = Field(description="Winsorise percentile (1–99) to clamp outliers. Defaults to 99.")
    min_detectable_effect: Optional[Union[StrictFloat, StrictInt]] = Field(description="Minimum detectable effect (relative, 0–1) for power planning. `null` to omit.")
    direction: StrictStr = Field(description="Desired direction of movement. `higher_better` (default), `lower_better`, or `neutral` (guardrail).")
