...
class UpdateErrorStatusRequest(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="New triage state. `resolved` reopens automatically on recurrence; `ignored` is sticky.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateErrorStatusRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateErrorStatusRequest from a dict"""
        if obj is None:
            return None
