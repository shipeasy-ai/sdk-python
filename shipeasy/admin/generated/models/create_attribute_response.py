...
class CreateAttributeResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Newly assigned attribute id.")
    name: StrictStr = Field(description="The attribute key that was created.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAttributeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAttributeResponse from a dict"""
        if obj is None:
            return None
