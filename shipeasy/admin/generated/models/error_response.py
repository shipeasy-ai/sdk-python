...
class ErrorResponse(BaseModel):
    ...
    code: Optional[StrictStr] = Field(default=None, description="Stable machine code, when applicable.")
    detail: Optional[StrictStr] = Field(default=None, description="Extra context (stack frames, validation details).")
