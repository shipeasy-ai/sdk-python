...
class UpdateConfigSchemaRequest(BaseModel):
    ...
    """ # noqa: E501
    var_schema: Dict[str, Any] = Field(description="Replacement JSON Schema (draft 2020-12). Validated against every published value before it lands.", alias="schema")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateConfigSchemaRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateConfigSchemaRequest from a dict"""
        if obj is None:
            return None
