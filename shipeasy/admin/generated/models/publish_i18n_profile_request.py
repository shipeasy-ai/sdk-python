...
class PublishI18nProfileRequest(BaseModel):
    """
    Body for `POST /api/admin/i18n/profiles/{profileId}/publish`. The `chunk` is an audit label only.
    """ # noqa: E501
    chunk: Optional[StrictStr] = Field(default=None, description="Optional chunk label to stamp on the audit log. Publishing is profile-wide regardless — the whole profile is snapshotted into one KV blob.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublishI18nProfileRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublishI18nProfileRequest from a dict"""
        if obj is None:
            return None
