...
class ListMetricsResponseInnerQueryIrAggOneOf6(BaseModel):
    """
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['unique']):
            raise ValueError("must be one of enum values ('unique')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListMetricsResponseInnerQueryIrAggOneOf6 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListMetricsResponseInnerQueryIrAggOneOf6 from a dict"""
        if obj is None:
            return None
