...
class MetricDisplayConfigBand(BaseModel):
    """
    ...
    """ # noqa: E501
    method: StrictStr
    sigma: Optional[Union[Annotated[float, Field(strict=True, gt=0)], Annotated[int, Field(strict=True, gt=0)]]] = Field(default=None, description="Half-width of the band in sigma-equivalents. Omit for 3, the sigma an alert rule also defaults to.")
    __properties: ClassVar[List[str]] = ["method", "sigma"]

    @field_validator('method')
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['seasonal']):
            raise ValueError("must be one of enum values ('seasonal')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetricDisplayConfigBand from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetricDisplayConfigBand from a dict"""
        if obj is None:
            return None
