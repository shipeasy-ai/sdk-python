...
class ExperimentApiRowGuardrailsInner(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(description="Optional gate name (a `targeting`-type flag). Only callers that pass the gate are enrolled in the experiment.")
    event_name: Optional[StrictStr] = Field(default=None, alias="eventName")
    __properties: ClassVar[List[str]] = ["id", "name", "eventName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExperimentApiRowGuardrailsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExperimentApiRowGuardrailsInner from a dict"""
        if obj is None:
            return None
