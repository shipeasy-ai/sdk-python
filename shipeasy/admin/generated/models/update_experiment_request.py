...
class UpdateExperimentRequest(BaseModel):
    ...
    guardrail_metrics: Optional[Annotated[List[CreateExperimentRequestGoalMetric], Field(max_length=10)]] = Field(default=None, description="Replaces the guardrail set wholesale (event auto-upserted per entry).")
