...
class AttributesApi:
    ...
    def create_attribute_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateAttributeResponse]:
        """Declare a targeting attribute
    ...
    def _create_attribute_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/admin/attributes',
    ...
    def delete_attribute(
        self,
        id: Annotated[str, Field(min_length=1, strict=True, max_length=128, description="The attribute id.")],
        x_project_id: Annotated[Optional[StrictStr], Field(description="Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def delete_attribute_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteAttributeResponse]:
        """Archive a targeting attribute
    ...
    def _delete_attribute_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/admin/attributes/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_attributes(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[ListAttributesResponseInner]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ListAttributesResponseInner]",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '404': "Error",
    ...
    def list_attributes_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ListAttributesResponseInner]]:
        """List targeting attributes
    ...
    def update_attribute_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateAttributeResponse]:
        """Update a targeting attribute
