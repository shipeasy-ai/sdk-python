...
class KeysApi:
    ...
    def list_i18n_keys(
        ...
        limit: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=1)]], Field(description="Max keys to return (1–500). Defaults to 200.")] = None,
        ...
        :type q: str
        :param limit: Max keys to return (1–500). Defaults to 200.
        :type limit: int
